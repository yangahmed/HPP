# Script for checking A6.tar.gz file for Assignment 6 subimssion
...
echo Copying A6.tar.gz file into tmpdir_for_checking directory

cp A6.tar.gz tmpdir_for_checking || exit 1

# cd into the tmpdir_for_checking directory
cd tmpdir_for_checking || exit 1

echo Unpacking the A6.tar.gz file
tar -xzf A6.tar.gz || exit 1
...
echo
echo Congratulations, your A6.tar.gz file seems OK!
echo
